...
public class VSMProtocol {
    ...
    /**
     * Load the VSM Protocol library from the default bundled resource.
     */
    public VSMProtocol() {
        this.lib = Native.load("vsmprotocol", VSMLib.class);
    }

    /**
     * Load the VSM Protocol library from a specific path.
