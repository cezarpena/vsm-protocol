...
extern char* GenerateVSMIdentity(void);
extern void FreeString(char* str);
extern void StartVSMServer(GoInt port, char* idStr, knock_callback knockCb, message_callback msgCb);
extern GoUint8 SendMessage(GoInt sessionID, char* message);
extern GoInt VSMDial(char* device, char* targetIP, GoInt port, char* idStr);
